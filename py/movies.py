"""
Setting up the movie database; creating a list of media.Movie to be displayed on the page.
"""
...
toy_story = media.Movie(
  ...
  "http://www.movie2kto.ws/uploads/newImage60510.jpg",
...
interstellar = media.Movie(
  "Interstellar",
  "Mankind was born on earth, but never meant to die here",
